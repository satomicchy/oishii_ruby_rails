...
class ShoppingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shopping" do
    assert_difference('Shopping.count') do
      post shoppings_url, params: { shopping: { memo: @shopping.memo, name: @shopping.name, unit: @shopping.unit } }
    end
  ...
  test "should update shopping" do
    patch shopping_url(@shopping), params: { shopping: { memo: @shopping.memo, name: @shopping.name, unit: @shopping.unit } }
